...
import 'package:normal_api/api_respons.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Normal Api Calling',style: TextStyle(fontSize: 15),),
      ),
      body: Center(
        child: Column(
...
class _ApidemoState extends State<Apidemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: load == 0 ? const Center(child: CircularProgressIndicator()) :  Column(
        children: [
          Expanded(
